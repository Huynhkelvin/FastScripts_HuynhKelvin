package com.fastscripts.model.services.manager;
...
public class PropertyManager {
	 ...
	 * 
	 * @param propertyFileLocation Location of the application.properties file using the -D method
	 * @throws PropertyFileNotFoundException Thrown if the file is not loaded
	 */
	 ...
	 * @return The string value that is associated with the key
	 */
